...
- **A real Level 2 — The Hollow Ruins**: the same ruined stone further down and further gone — darker, damper, lit by cold fungal growth instead of fire, with its own composed encounters, zone-bound events, and an opt-in three-wave ritual arena (the Drowned Sanctum) paying out Rare-or-better. Zones connect through **stairwells**, not teleports: a sealed, rune-carved lid in the heart room grinds open once the guardian falls, and descending is a scripted moment (walk into the well, fade to black, arrive at the foot of the matching stairs below).
...
- **3 weapons, 3 abilities, 10 enemies** — two weapons, two abilities, and one enemy type are unlockable via the Armory.
